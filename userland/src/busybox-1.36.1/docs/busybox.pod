...
Currently available applets include:
	...
	ash, awk, basename, bunzip2, bzcat, cat, clear, comm, cp, cut, date,
	dd, df, dirname, du, echo, egrep, env, expand, false, fgrep, find,
	fold, grep, gunzip, gzip, head, hexdump, hostname, id, kill,
	killall, killall5, ln, ls, md5sum, mkdir, mv, nl, nproc, od, paste,
	printenv, printf, pwd, readlink, realpath, reset, rm, rmdir, sed,
	seq, sh, sha1sum, sha256sum, sha512sum, sleep, sort, stat, strings,
	stty, tac, tail, tar, tee, test, time, touch, tr, true, tty, uname,
	unexpand, uniq, unxz, usleep, watch, wc, which, whoami, xargs,
	xzcat, yes, zcat
...
tar x|t [-avokO] [-f TARFILE] [-C DIR] [FILE]...
